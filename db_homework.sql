...
--
-- Хост: 127.0.0.1
-- Время создания: Фев 23 2021 г., 12:57
...
INSERT INTO `electronics` (`id`, `title`, `price`, `description`, `category`, `image`) VALUES
...
INSERT INTO `jewelery` (`id`, `title`, `price`, `description`, `category`, `image`) VALUES
...
--
-- Структура таблицы `men-clothing`
--

CREATE TABLE `men-clothing` (
  `id` int(11) NOT NULL,
  `title` text NOT NULL,
  `price` text NOT NULL,
  `description` text NOT NULL,
...
--
-- Дамп данных таблицы `men-clothing`
--

INSERT INTO `men-clothing` (`id`, `title`, `price`, `description`, `category`, `image`) VALUES
(1, 'Fjallraven - Foldsack No. 1 Backpack, Fits 15 Laptops', '109.95', 'Your perfect pack for everyday use and walks in the forest. Stash your laptop (up to 15 inches) in the padded sleeve, your everyday', 'men clothing', 'https://fakestoreapi.com/img/81fPKd-2AYL._AC_SL1500_.jpg'),
...
(3, 'Mens Cotton Jacket', '55.99', 'great outerwear jackets for Spring/Autumn/Winter, suitable for many occasions, such as working, hiking, camping, mountain/rock climbing, cycling, traveling or other outdoors. Good gift choice for you or your family member. A warm hearted love to Father, husband or son in this thanksgiving or Christmas Day.', 'men clothing', 'https://fakestoreapi.com/img/71li-ujtlUL._AC_UX679_.jpg'),
(4, 'Mens Casual Slim Fit', '15.99', 'The color could be slightly different between on the screen and in practice. / Please note that body builds vary by person, therefore, detailed size information should be reviewed below on the product description.', 'men clothing', 'https://fakestoreapi.com/img/71YXzeOuslL._AC_UY879_.jpg');
...
INSERT INTO `pages` (`id`, `path`, `name`) VALUES
(1, 'electronics', 'Electronics'),
(2, 'jewelery', 'Jewelery'),
(3, 'men-clothing', 'Men clothing'),
(4, 'women-clothing', 'Women clothing');

-- --------------------------------------------------------

--
-- Структура таблицы `women-clothing`
--

CREATE TABLE `women-clothing` (
  `id` int(11) NOT NULL,
  `title` text NOT NULL,
  `price` text NOT NULL,
  `description` text NOT NULL,
...
--
-- Дамп данных таблицы `women-clothing`
--

INSERT INTO `women-clothing` (`id`, `title`, `price`, `description`, `category`, `image`) VALUES
...
(18, 'MBJ Women\'s Solid Short Sleeve Boat Neck V ', '9.85', '95% RAYON 5% SPANDEX, Made in USA or Imported, Do Not Bleach, Lightweight fabric with great stretch for comfort, Ribbed on sleeves and neckline / Double stitching on bottom hem', 'women clothing', 'https://fakestoreapi.com/img/71z3kpMAYsL._AC_UY879_.jpg'),
...
--
-- Индексы таблицы `men-clothing`
--
ALTER TABLE `men-clothing`
  ADD PRIMARY KEY (`id`);
...
--
-- Индексы таблицы `women-clothing`
--
ALTER TABLE `women-clothing`
  ADD PRIMARY KEY (`id`);
